...
THREE.GPUParticleSystem = function( options ) {
    ...
    var GPUParticleShader = {
        ...
        vertexShader: [
            ...
            '   float highFrequency = -.5 * turbulenceFunc(.7 * (position.xyz + vec3(in_val)));',
			...
			'	newPosition = positionStart + ( v * 10.0 ) * ( uTime - startTime ) * displacement;',
